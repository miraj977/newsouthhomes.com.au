...
jQuery(document).ready(function(){
	jQuery(':input[data-filter="single-storey"]').on("click", function(event) { 
	 event.preventDefault();
	  window.open('<?php echo site_url()."/home-designs/single-storey";?>', '_blank');
	});
});
jQuery(':input[data-filter="double-storey"]').prop('checked', true).click();
</script>
