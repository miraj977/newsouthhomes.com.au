<div id="filters-desktop" class="desktop hd-filter">
...
foreach ($storeys as $storey) {
            ...
            <div class="filter-button">
                <label class="checkWrap">
                    ...
                    <span class="check-span checkmark"> <img src="<?php echo get_template_directory_uri() . $img; ?>"
                            class="p-5" style="max-width:42px;"><?php echo $storey->name; ?>
                    </span>
                </label>
            </div>
    ...
    <div class="bedroom checkboxFilter">
        ...
        <div class="flex filter-icon" style="overflow:hidden;justify-content: flex-start;">
...
foreach ($bedrooms as $bedroom) {
    ?>
            <div class="filter-check" style="flex-grow:1;max-width: 56px;">
                <label class="checkWrap">
                    <input type="checkbox" data-filter="<?php echo $bedroom->slug . 'bed'; ?>"
                        class="works-filter bedroomsCheck control" name="bedrooms" value="<?php echo $bedroom->slug ?>">
                    <span
            ...
            <div class="filter-check" style="flex-grow:1;max-width: 56px;">
                <label class="checkWrap">
                    <input type="checkbox" data-filter="<?php echo $bath->slug . 'bath'; ?>"
                        class="works-filter control bathroomsCheck" name="bathrooms" value="<?php echo $bath->slug ?>">
                    <span
                        class="check-span checkmark"><?php echo str_replace("s", '', str_replace("Bathroom", "", $bath->name)) ?></span>
                </label>
            </div>
    ...
    ?>
            <div class="filter-button">
                <label class="checkWrap">
                    ...
                    <span class="check-span checkmark"> <img src="<?php echo get_template_directory_uri() . $img; ?>"
                            class="p-5 hometype-img" style="max-width:80px;"><?php echo $home_type->name; ?>
                    </span>
