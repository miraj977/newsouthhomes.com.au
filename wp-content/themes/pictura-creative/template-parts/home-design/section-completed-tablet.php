 <div class="flex showhide-div">
     <button class="hidefilter" id="hidefilter5"> SHOW FILTERS</button>
 </div>
...
foreach ($allBathroom as $bath) {
    ?>
                 <div class="filter-check" style="flex: 0 0 18%;">
                     <label class="checkWrap">
                         ...
                         <span
                             class="check-span checkmark" style="padding: 10px 15px;"><?php echo str_replace("s", '', str_replace("Bathroom", "", $bath->name)) ?></span>
                     </label>
                 </div>
