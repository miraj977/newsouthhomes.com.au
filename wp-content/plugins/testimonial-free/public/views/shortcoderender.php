...
if (!class_exists('TFREE_Shortcode_Render')) {
    class TFREE_Shortcode_Render
    {
        ...
        public function shortcode_render($attributes)
        {
            ...
            $pagination_colors = isset($shortcode_data['pagination_colors']) ? $shortcode_data['pagination_colors'] : '#ccc0';
            $pagination_color = isset($pagination_colors['color']) ? $pagination_colors['color'] : '#ccc0';
