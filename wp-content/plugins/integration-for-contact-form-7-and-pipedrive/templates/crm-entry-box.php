...
<div class="box_btns_div">
  <button class="button" type="submit" name="<?php echo $this->id ?>_send_btn" value="yes"><?php echo __("Send to Pipedrive",'cf7-pipedrive')?></button>
  <?php
      if($comments ){
  ?>
  <a href="<?php echo $log_url ?>" class="button"><?php echo __("Go to Logs",'cf7-pipedrive')?></a>
  <?php
      }
  ?>
  </div>
