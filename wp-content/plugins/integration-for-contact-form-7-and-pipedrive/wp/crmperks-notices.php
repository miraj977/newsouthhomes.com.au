...
$msg =sprintf(__('Want to save conatct form 7 submissions? Manage contact form 7 entries , View Pipedrive status of any entry and Send any entry to Pipedrive with free %sConatct Form Entries Plugin%s','crm-perks-forms'),'<a href="https://wordpress.org/plugins/contact-form-entries/" target="_blank">','</a>');
?>
...
//$install_time['review_closed']='';
 ...
 if(!empty($install_time) && is_array($install_time) && !empty($install_time['time']) && empty($install_time['review_closed'])){
  ...
  <p><?php echo sprintf(__( 'You\'ve been using Contact Form 7 pipedrive Plugin for some time now; we hope you love it!.%s If you do, please %s leave us a %s rating on WordPress.org%s to help us spread the word and boost our motivation.','contact-form-entries'),'<br/>','<a href="'.$this->review_link.'" target="_blank" rel="noopener noreferrer">','&#9733;&#9733;&#9733;&#9733;&#9733;','</a>'); ?></p>
...
<p><i class="fa fa-check"></i> Pipedrive Phone Number and All Custom fields.</p>
